...
foreach ($estatus as $id=>$estado)
	...
	echo "<td align=center>";	
	echo "<h4>";
if(in_array($_COOKIE['acceso'],$permisos_admin)){echo "<a href=historial_certificacion_borrar.php?id=".$id."&socio=".$_GET["socio"]."><img title='borrar este estado' src=images/cross.png width=25></a>";}
	echo "</h4></td></tr>";
	}
echo "</table>";
echo "<br><br>
...
if(in_array($_COOKIE['acceso'],$permisos_admin)){echo "<td><a href=historial_certificacion_nuevo.php?socio=".$_GET["socio"]."><h3>AÑADIR</h3></a></td>";}
