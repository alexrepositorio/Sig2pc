...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2015 a las 05:37:04
...
--
ALTER TABLE `usuarios`
ADD CONSTRAINT `FK_USUARIO_NIVEL` FOREIGN KEY (`id_nivel`) REFERENCES `niveles` (`id_niveles`),
ADD CONSTRAINT `FK_USUARIO_PERSONA` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`) ON DELETE NO ACTION ON UPDATE NO ACTION;
